...
const ROLES = {
  ...
  "DAT-A":     { code: "DAT-A",     title: "詹指",   group: "赛后话题组", tag: "赛后第一件事打开MatchMate看数据", shortLabel: "用MatchMate的评分说服你那个进球其实是运气", quote: "这个数据很有意思", image: "./images_new/DAT-A.png" },
  ...
  "BOT-TLE":   { code: "BOT-TLE",   title: "瓶子哥",     group: "赛后话题组", tag: "比赛还没结束梗图已经做好了",   shortLabel: "看球不是为了看球，是为了第一时间截到能发群的表情包", quote: "我就是我", image: "./images_new/BOT-TLE.png" },
  ...
  "BURGER":   { code: "BURGER",   title: "汉堡王",   group: "搭子风格组", tag: "对对对你说得对",               shortLabel: "擅长附和，让每个人都觉得自己说得有道理", quote: "大家都很好", image: "./images_new/BURGER.png" },
  "MA-DING":  { code: "MA-DING",  title: "大马丁",     group: "搭子风格组", tag: "该说的难听话一句不少",         shortLabel: "不怕得罪人，觉得真话比好话有用，骂球员从不手软", quote: "真话不好听", image: "./images_new/MA-DING.png" },
  ...
  "ZI-DANE":  { code: "ZI-DANE",  title: "齐祖",     group: "特殊人格",   tag: "越乱越来劲",                   shortLabel: "别人看球怕意外，他看球就盼意外", quote: "Why Always Me", image: "./images_new/ZI-DANE.png" },

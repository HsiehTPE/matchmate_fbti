...
const ROLES = {
  ...
  "CN-12":   { code: "CN-12",   title: "第12人",   group: "搭子风格组", tag: "一个人就是一支啦啦队",         shortLabel: "和他看球永远不会冷场，进球时比球员还激动", quote: "下一场一定赢", image: "./images_new/CN-12-v2.png" },
  ...
  "BURGER":   { code: "BURGER",   title: "汉堡王",   group: "搭子风格组", tag: "对对对你说得对",               shortLabel: "擅长附和，让每个人都觉得自己说得有道理", quote: "大家都很好", image: "./images_new/BURGER-v2.png" },
  "MA-DING":  { code: "MA-DING",  title: "大马丁",     group: "搭子风格组", tag: "该说的难听话一句不少",         shortLabel: "不怕得罪人，觉得真话比好话有用，骂球员从不手软", quote: "真话不好听", image: "./images_new/MA-DING-v2.png" },
  ...
  "TUI-Q":    { code: "TUI-Q",    title: "退钱哥",   group: "搭子风格组", tag: "输了一起骂赢了一起吹",         shortLabel: "情绪价值拉满的看球搭子，你需要什么他就给什么", quote: "我xxx，退钱！", image: "./images_new/TUI-Q-v2.png" },
  ...
  "TEN-GOD":      { code: "TEN-GOD",      title: "滕圣",   group: "足球哲学组", tag: "能赢就行要什么自行车",         shortLabel: "结果导向，过程不重要，3分到手就是好球", quote: "我们踢得不错", image: "./images_new/TEN-GOD.png" },
  "1100":   { code: "1100",   displayCode: "1100(宋)",   title: "高俅",   group: "足球哲学组", tag: "以前的足球才叫足球",           shortLabel: "觉得现在什么都差点意思，聊球必提以前", quote: "我刚开始看足球的那个时候...", image: "./images_new/1100-v2.png" },
  "CARD-MA":    { code: "CARD-MA",    title: "卡牌大师",   group: "足球哲学组", tag: "争议第一反应翻规则手册",       shortLabel: "看VAR比看进球认真，觉得公平是足球的底线", quote: "规则就是规则", image: "./images_new/CARD-MA-v2.png" },
  ...
  "ZI-DANE":  { code: "ZI-DANE",  title: "齐祖",     group: "特殊人格",   tag: "越乱越来劲",                   shortLabel: "别人看球怕意外，他看球就盼意外", quote: "Why Always Me", image: "./images_new/ZI-DANE-v2.png" },
  "DINHO":  { code: "DINHO",  title: "小罗",     group: "特殊人格",   tag: "稳定之外也要留给传奇空间",     shortLabel: "正经分析他也会，但他更愿意等那个不可能的瞬间", quote: "规则是用来打破的", image: "./images_new/DINHO-v2.png" }
};
